...
const APP_MAP: &[(&str, Category)] = &[
    ...
    ("code - insiders.exe", Category::Work),
    ("cursor.exe", Category::Work),
    ("devenv.exe", Category::Work),
    ("idea64.exe", Category::Work),
    ("pycharm64.exe", Category::Work),
    ("webstorm64.exe", Category::Work),
    ("goland64.exe", Category::Work),
    ("clion64.exe", Category::Work),
    ("rider64.exe", Category::Work),
    ("rustrover64.exe", Category::Work),
    ("sublime_text.exe", Category::Work),
    ...
    ("docker desktop.exe", Category::Work),
    ("postman.exe", Category::Work),
    ("figma.exe", Category::Work),
    ("gitkraken.exe", Category::Work),
    ("sourcetree.exe", Category::Work),
    // productivity
    ("slack.exe", Category::Productivity),
    ("teams.exe", Category::Productivity),
    ("ms-teams.exe", Category::Productivity),
    ...
    ("powerpnt.exe", Category::Productivity),
    ("onenote.exe", Category::Productivity),
    ("outlook.exe", Category::Productivity),
    ("acrobat.exe", Category::Productivity),
    ("acrord32.exe", Category::Productivity),
    ("zoom.exe", Category::Productivity),
    ("todoist.exe", Category::Productivity),
    ("ticktick.exe", Category::Productivity),
    // entertainment
    ("spotify.exe", Category::Entertainment),
    ("vlc.exe", Category::Entertainment),
    ("mpc-hc64.exe", Category::Entertainment),
    ("mpc-hc.exe", Category::Entertainment),
    ("steam.exe", Category::Entertainment),
    ("epicgameslauncher.exe", Category::Entertainment),
    ("steamwebhelper.exe", Category::Entertainment),
    // social
    ("discord.exe", Category::Social),
    ("telegram.exe", Category::Social),
    ("whatsapp.exe", Category::Social),
    ("signal.exe", Category::Social),
];
